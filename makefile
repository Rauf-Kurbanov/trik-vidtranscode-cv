...
DSPLIB_INSTALL_DIR?=$(DEPOT_DSP)-L/c674x/dsplib_v12/
...
XDCPATH?=$(CE_INSTALL_DIR)/packages;$(XDAIS_INSTALL_DIR)/packages;$(DSPLIB_INSTALL_DIR);$(IMGLIB_INSTALL_DIR)/packages
